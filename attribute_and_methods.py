class Point2D:
    ...
    def __init__(self, x, y):
        ...
        # При инициализации нового класса увеличивается количество
    ...
    def __add__(self, other):
        ...
        Параметры:
            - other (Point2D): вернуть новый объект_сумму;
        ...
        if isinstance(other, self.__class__):
            ...
            # Точка и число
            # Добавим к обеим координатам self число other и вернём результат
            # Возвращаем старыйб измененный объект!
            self.x += other
            self.y += other
            return self
        else:
    ...
    def __sub__(self, other):
        '''Создать новый объект как разность координать self и other.'''
        return Point2D(self.x - other.x, self.y - other.y)
    ...
    def sum(*points):
        ...
        '''
        assert len(points) > 0, 'Колличество суммируемых точек = 0'
    ...
    def from_string(cls, str_value):
        '''Создать экземляр класса из строки 'str_value'.
...
if __name__ == "__main__":
    ...
    # Создаём 3-ю точку через метод класса
